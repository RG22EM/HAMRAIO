...
/* Modify
 *  UA6EM
 *  25.09.2020 Добавлена возможность расширения
 *  интерфейса под ICOM CI-V (Icom-706)
 *  26.02.2020
 *  08.02.2020 add 3-BAND and STRUCT in EEPROM 
 *  BUTTON - http://www.avr-asm-tutorial.net/avr_en/apps/key_matrix/keypad/keyboard.html
...
// ******* Обработчик САТ интерфейса YAESU/ICOM *******
#ifdef RIG
